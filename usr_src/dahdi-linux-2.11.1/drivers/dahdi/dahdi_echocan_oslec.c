 ...
 * ECHO_CAN_OSLEC
 *
 * Written by Eric Wilde <ewilde@bsmdevelopment.com>
 *
 * Adapted from OSLEC shim written by Tzafrir Cohen
 ...
 *
 * Echo canceller written by Steve Underwood <steveu@coppice.org>
...
/* Stuff specific to this echo canceller */
...
/* The functions we expose the echo canceller factory */
...
/* Constants used to anchor the echo canceller */
...
MODULE_DESCRIPTION("DAHDI 'OSLEC' Echo Canceler");
MODULE_AUTHOR("Eric Wilde <ewilde@bsmdevelopment.com>");
